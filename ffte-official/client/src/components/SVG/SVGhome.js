          ...
          <g class="transparent-text">
            ...
            >
              ...
              <a href="#shop" class="shop">
                <tspan class="cls-2" x="263.83" y="0">F</tspan>
              </a>
              <a href="http://ffteblog.com/" class="blog">
                <tspan class="cls-3" x="548.24" y="0">T</tspan>
              </a>
              <a href="#connect" class="connect">
                <tspan class="cls-3" x="850.24" y="0">E</tspan>
              </a>
            </text>
            <a href="#artist" class="artist">
              <text
              ...
              >
                F
                <tspan class="cls-5" x="52.29" y="0">a</tspan>
                <tspan class="cls-6" x="86.9" y="0">r</tspan>
              </text>
            </a>
            <a href="#shop" class="shop">
              <text
              ...
              >
                ...
                <tspan class="cls-8" x="39.31" y="0">r</tspan>
                <tspan class="cls-9" x="67.29" y="0">o</tspan>
                <tspan x="85.89" y="0">m</tspan>
              </text>
            </a>
            <a href="http://ffteblog.com/" class="blog">
              <text
              ...
              >
                ...
                <tspan class="cls-11" x="50.28" y="0">h</tspan>
                <tspan x="73.8" y="0">e</tspan>
              </text>
            </a>
            <a href="#contact" class="contact">
              ...
              >
                E
                <tspan class="cls-12" x="50.63" y="0">a</tspan>
                <tspan class="cls-13" x="75.49" y="0">s</tspan>
                <tspan x="119.95" y="0">t</tspan>
              </text>
            </a>
          </g>
          <mask id="header-mask">
